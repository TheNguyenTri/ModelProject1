...
public class BookAdapterTop10 extends BaseAdapter implements Filterable {
    List<Sach> arrSach;
    ...
    public BookAdapterTop10(Activity context, List<Sach> arraySach) {
        super();
...
//        ImageView imgDelete;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_booktop10, null);
...
//            });
    ...
    public void changeDatasetBookTop10(List<Sach> items) {
        this.arrSach = items;
        notifyDataSetChanged();
    }
